 ...
 * </p>
 *
 * @see org.fuin.dsl.cqrs.cqrsDSL.CqrsDSLPackage#getNamespace()
 * @model
 * @generated
 */
public interface Namespace extends EObject
{
   ...
   * @see #setName(String)
   * @see org.fuin.dsl.cqrs.cqrsDSL.CqrsDSLPackage#getNamespace_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.fuin.dsl.cqrs.cqrsDSL.Namespace#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.fuin.dsl.cqrs.cqrsDSL.CqrsDSLPackage#getNamespace_Imports()
